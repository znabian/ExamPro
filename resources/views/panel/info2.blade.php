    ...
    <div id="loginDesktopContainer">
        <div id="loginContainer">
            ...
            <div id="loginContainerBody">
                <form method="post" action="{{route('myExamSetinfo')}}">
                    @csrf
                    @if(!auth()->user()->firstName)
                    <label for="name">{{__('messages.نام و نام خانوادگی')}} </label>
                    <br>
                    <input type="text" required id="name" autocomplete="off"  name="name" value="{{auth()->user()->firstName.' '.auth()->user()->lastName}}">
                    @endif
                    @if(!auth()->user()->age)                    
                    <br>
        ...
        <div id="loginContainer">
            ...
            <div id="loginContainerBody">
                <form method="post" action="{{route('myExamSetinfo')}}">
                    ...
                    <br>
                    <input type="text" required id="phoneNumberInputMobile" autocomplete="off"  name="name" value="{{auth()->user()->firstName.' '.auth()->user()->lastName}}">
                    <br>
                    @endif
                    @if(!auth()->user()->age) 
